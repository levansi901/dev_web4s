                    ...
                    <tbody class="kt-datatable__body">
                        <tr data-row="0" class="kt-datatable__row" style="left: 0px;">
                            ...
                            <td data-field="OrderID" class="kt-datatable__cell">
                                <span style="width: 214px;">0374-5070</span>
                            </td>
                            <td data-field="Country" class="kt-datatable__cell">
                                <span style="width: 214px;">China CN</span>
                            </td>
                            <td data-field="ShipDate" class="kt-datatable__cell">
                                <span style="width: 214px;">8/27/2017</span>
                            </td>
                            <td data-field="CompanyName" class="kt-datatable__cell">
                                <span style="width: 214px;">Kris-Wehner</span>
                            </td>
                            <td data-field="Status" class="kt-datatable__cell">
                                <span style="width: 214px;">
                                    <span class="kt-badge  kt-badge--danger kt-badge--inline kt-badge--pill">Danger</span>
                                </span>
                            </td>
                            <td data-field="Type" data-autohide-disabled="false" class="kt-datatable__cell">
                                <span style="width: 214px;">
                                    ...
                                    <span class="kt-font-bold kt-font-primary">Retail</span>
                                </span>
                            </td>
